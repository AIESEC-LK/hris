...
const routes: Routes = [
	...
	{ path: 'members/groups', component: GroupMembersComponent },
	{ path: 'members/groups/create', component: CreateGroupComponent },
	{ path: 'members/groups/edit/:id', component: CreateGroupComponent },
